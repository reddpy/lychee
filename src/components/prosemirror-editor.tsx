...
import { Editor } from "@/components/editor-pm/editor";
...
function getSerializedState(
  ...
  try {
    ...
    if (parsed && typeof parsed === "object") {
      // Accept both Lexical format (has .root) and PM format (has .type === "doc")
      if (parsed.root || parsed.type === "doc") return parsed;
    }
  } catch {
    // ignore invalid JSON
  }
