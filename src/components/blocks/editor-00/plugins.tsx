...
export function Plugins() {
  ...
  return (
    <div className="relative">
      ...
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex flex-wrap items-center gap-1 overflow-auto bg-background/95 px-2 py-1.5 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <BlockFormatDropDown>
              <FormatParagraph />
            ...
            <div className="min-h-[200px]">
              <div ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block min-h-[200px] min-h-full overflow-auto pl-10 pr-4 py-3 focus:outline-none"
                  placeholderClassName="text-muted-foreground pointer-events-none absolute top-0 left-0 overflow-hidden pl-10 pr-4 py-3 text-ellipsis select-none"
                />
              </div>
            </div>
          }
