    ...
    <LexicalTypeaheadMenuPlugin<SlashCommandOption>
      ...
      menuRenderFn={(
        ...
        anchorElementRef.current && options.length
          ? createPortal(
              <div className="fixed z-50 w-[200px] max-h-[280px] overflow-y-auto rounded-md border border-[hsl(var(--border))] bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95">
